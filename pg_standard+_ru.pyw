...
components_right = [
    ...
    [sg.Checkbox('Автокопирование первой строки', default=True, key='-AUTOCOPY_BOX-'), sg.Button('Сгенерировать', focus=True, size=(13,1), key='-GEN-'),
     sg.Button('Объединить', tooltip=mix_menu, size=(9,1),key= '-MIX-')],
    [sg.Checkbox('Надёжный', tooltip=trustworthy, default=True, key='-GOOD_GEN-'), sg.Checkbox('Надёжные шаблоны', tooltip=trustworthy_tmp, default=False, key='-GOOD_TMP-')]
]
